  ...
  const sidebarContent = (
    <Box
      ...
      sx={{
        ...
        height: '100vh',
        background: 'linear-gradient(180deg, #0a0e1a 0%, #1a1a2e 40%, #16213e 70%, #0a0e1a 100%)',
        color: 'white',
        display: 'flex',
        ...
        '&::before': {
          ...
          right: 0,
          bottom: 0,
          background: 'radial-gradient(ellipse at 0% 0%, rgba(96, 165, 250, 0.08) 0%, transparent 50%), radial-gradient(ellipse at 100% 100%, rgba(167, 139, 250, 0.08) 0%, transparent 50%)',
          pointerEvents: 'none',
        },
      }}
    >
            ...
            {isResizing && (
              <Box
                sx={{
                  ...
                  bottom: 0,
                  width: 60,
                  background: 'linear-gradient(90deg, transparent, rgba(96, 165, 250, 0.05) 50%, transparent)',
      ...
      <Box
        sx={{
          ...
          flexShrink: 0,
          background: 'linear-gradient(135deg, rgba(96, 165, 250, 0.1) 0%, rgba(167, 139, 250, 0.05) 50%, transparent 100%)',
          position: 'relative',
          '&::after': {
            content: '""',
            position: 'absolute',
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 1 }}>
          ...
          <Badge
            ...
            sx={{
              '& .MuiBadge-badge': {
                bgcolor: 'linear-gradient(135deg, #60a5fa, #a78bfa)',
                fontWeight: 700,
                fontSize: '0.7rem',
                height: 24,
                minWidth: 24,
        ...
        <List disablePadding>
          {filteredQuestions.length === 0 ? (
            ...
            >
              ...
              <Typography variant="body2" sx={{ mb: 1, color: 'rgba(255,255,255,0.4)' }}>
                No questions match
              </Typography>
                    ...
                    <ListItemIcon sx={{ minWidth: 32, mr: 1, display: 'flex', justifyContent: 'center' }}>
                      <Box
                        ...
                        sx={{
                          ...
                          alignItems: 'center',
                          justifyContent: 'center',
                          background: currentQuestion === question.id 
                            ? 'linear-gradient(135deg, rgba(96, 165, 250, 0.3), rgba(167, 139, 250, 0.3))'
                            : 'rgba(255,255,255,0.04)',
                          border: '1px solid',
                          borderColor: currentQuestion === question.id 
                            ? 'rgba(96, 165, 250, 0.3)' 
                            : 'rgba(255,255,255,0.05)',
                          transition: 'all 0.3s ease',
                          color: currentQuestion === question.id ? '#60a5fa' : 'rgba(255,255,255,0.4)',
                        }}
                      >
                        <Code size={14} />
                      </Box>
                    ...
                    <ListItemText
                      primary={
                        <Typography
                          variant="body2"
                          sx={{
                            color: currentQuestion === question.id ? 'white' : 'rgba(255,255,255,0.7)',
        ...
        {filteredQuestions.length > 0 && (
          ...
          >
            {[
              ...
              { label: 'Viewed', value: currentQuestion ? '1' : '0', icon: Zap },
              { label: 'Progress', value: `${questions.length > 0 ? Math.round((currentQuestion ? 1 : 0) / questions.length * 100) : 0}%`, icon: TrendingUp },
            ].map((stat, idx) => (
